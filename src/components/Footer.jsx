...
<footer className="bg-gray-700 text-center text-white-500 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
  ...
  <div className="container mx-auto px-10">
    <div className="flex items-center justify-center lg:justify-between">
      ...
      <div className="flex justify-center">
        <a href="https://www.facebook.com/story.php?story_fbid=122094050708571119&id=61567133572338&rdid=7vfARfsn9VHYnT5Z" className="me-6 text-gray-500 dark:text-gray-200" target='blank' >
          <svg
...
<div className="container mx-auto px-4">
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      <div className="">
        <h6
          className="mb-4 flex items-center justify-center font-semibold text-yellow-500 uppercase md:justify-start">
          <img
            src={Logo}
            viewBox="0 0 20 20"
            fill="currentColor"
  ...
  <p className="mb-4 flex items-center">
    ...
    <Link to="/volunteer" className="text-white-500 dark:text-white-200 hover:text-yellow-500">
      ...
      <div className="">
        <h6
          className="mb-4 flex justify-center  text-yellow-500 font-bold uppercase md:justify-start">
      ...
      <div className="">
        <h6
          className="mb-4 flex justify-center font-bold text-yellow-500 uppercase md:justify-start">
          Popular Links 
        </h6>
        <p className="mb-4">
...
<div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
  ...
  <a
    ...
    href="/"
    >United Nations Soldiers of Peace Association </a>
</div>
</footer>
