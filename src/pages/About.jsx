          ...
          <div className="px-4 py-4 border rounded-lg border-light dark:border-dark-3 shadow-1 dark:shadow-card bg-tg-bg dark:bg-dark-2 sm:px-6 md:px-8 md:py-5">
            <ul className="flex items-center">
              <li className="flex items-center">
                <Link
                  to="/"
                  className="flex items-center text-base font-medium hover:text-black dark:hover:text-dark text-black dark:text-yellow"
                >
                  <span className="pr-2">
                    <svg
                      width="15"
              ...
              <li className="text-base font-medium text-yellow-500">About</li>
            </ul>
          </div>
        </div>
      </div>
